    ...
    rule single_exec___start0___x64
    {
        meta:
            desc = "Metasploit::windows::x64::single_exec::__start0__"
    ...
    rule single_exec_api_call_x64
    {
        meta:
            desc = "Metasploit::windows::x64::single_exec::api_call"
    ...
    rule single_exec_next_mod_x64
    {
        meta:
            desc = "Metasploit::windows::x64::single_exec::next_mod"
    ...
    rule single_exec_loop_modname_x64
    {
        meta:
            desc = "Metasploit::windows::x64::single_exec::loop_modname"
    ...
    rule single_exec_not_lowercase_x64
    {
        meta:
            desc = "Metasploit::windows::x64::single_exec::not_lowercase"
    ...
    rule single_exec_get_next_func_x64
    {
        meta:
            desc = "Metasploit::windows::x64::single_exec::get_next_func"
    ...
    rule single_exec_loop_funcname_x64
    {
        meta:
            desc = "Metasploit::windows::x64::single_exec::loop_funcname"
    ...
    rule single_exec_finish_x64
    {
        meta:
            desc = "Metasploit::windows::x64::single_exec::finish"
    ...
    rule single_exec_get_next_mod1_x64
    {
        meta:
            desc = "Metasploit::windows::x64::single_exec::get_next_mod1"
    ...
    rule single_exec_start_x64
    {
        meta:
            desc = "Metasploit::windows::x64::single_exec::start"
    
        /*
            5D                   | ]                    | pop rbp
            BA01000000           | .....                | mov rdx, 1
            488D8D04010000       | H......              | lea rcx, [rbp+command-delta]
            41BA318B6F87         | A.1.o.               | mov r10d, 0x876f8b31
            FFD5                 | ..                   | call rbp
        */
    
        strings:
            $a   = { 5d ba 01 00 00 00 48 8d 8d 04 01 00 00 41 ba 31 8b 6f 87 ff d5 }
    ...
    rule single_exec_exitfunk_x64
    {
        meta:
            desc = "Metasploit::windows::x64::single_exec::exitfunk"
    ...
    rule single_exec_goodbye_x64
    {
        meta:
            desc = "Metasploit::windows::x64::single_exec::goodbye"
