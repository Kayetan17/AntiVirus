    ...
    rule win32_stage_boot_reverse_lgetprocaddress_x86
    {
        meta:
            desc = "Metasploit::windows::x86::win32_stage_boot_reverse::lgetprocaddress"
    ...
    rule win32_stage_boot_reverse_lfnlp_x86
    {
        meta:
            desc = "Metasploit::windows::x86::win32_stage_boot_reverse::lfnlp"
    ...
    rule win32_stage_boot_reverse_lhshlp_x86
    {
        meta:
            desc = "Metasploit::windows::x86::win32_stage_boot_reverse::lhshlp"
    ...
    rule win32_stage_boot_reverse_lfnd_x86
    {
        meta:
            desc = "Metasploit::windows::x86::win32_stage_boot_reverse::lfnd"
    ...
    rule win32_stage_boot_reverse_ldone_x86
    {
        meta:
            desc = "Metasploit::windows::x86::win32_stage_boot_reverse::ldone"
    ...
    rule win32_stage_boot_reverse_lkernel32base_x86
    {
        meta:
            desc = "Metasploit::windows::x86::win32_stage_boot_reverse::lkernel32base"
    ...
    rule win32_stage_boot_reverse_lloadwinsock_x86
    {
        meta:
            desc = "Metasploit::windows::x86::win32_stage_boot_reverse::lloadwinsock"
    ...
    rule win32_stage_boot_reverse_looper_x86
    {
        meta:
            desc = "Metasploit::windows::x86::win32_stage_boot_reverse::looper"
    ...
    rule win32_stage_boot_reverse_lwsastartup_x86
    {
        meta:
            desc = "Metasploit::windows::x86::win32_stage_boot_reverse::lwsastartup"
    ...
    rule win32_stage_boot_reverse_lwsasocketa_x86
    {
        meta:
            desc = "Metasploit::windows::x86::win32_stage_boot_reverse::lwsasocketa"
    ...
    rule win32_stage_boot_reverse_lconnect_x86
    {
        meta:
            desc = "Metasploit::windows::x86::win32_stage_boot_reverse::lconnect"
