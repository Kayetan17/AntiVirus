    ...
    rule stager_bind_tcp___start0___x86
    {
        meta:
            desc = "Metasploit::windows::x86::stager_bind_tcp::__start0__"
        ...
        /*
            ...
            51                   | Q                    | push ecx
            57                   | W                    | push edi
            66B9803B             | f..;                 | mov cx,0x3b80
            FFD6                 | ..                   | call esi
            53                   | S                    | push ebx
            57                   | W                    | push edi
            66B97549             | f.uI                 | mov cx,0x4975
            FFD6                 | ..                   | call esi
            54                   | T                    | push esp
            54                   | T                    | push esp
            54                   | T                    | push esp
            57                   | W                    | push edi
            66B9324C             | f.2L                 | mov cx,0x4c32
            FFD6                 | ..                   | call esi
            97                   | .                    | xchg eax,edi
            50                   | P                    | push eax
            66B933CE             | f.3.                 | mov cx,0xce33
            FFD6                 | ..                   | call esi
            89E1                 | ..                   | mov ecx,esp
            50                   | P                    | push eax
            B40C                 | ..                   | mov ah,0xc
            ...
            650F885A000000       | e..Z...              | gs js 0x135
            202F                 |  /                   | and [edi],ch
            6320                 | c                    | arpl [eax],sp
            6E                   | n                    | outsb
            650F8411000000       | e......              | gs jz 0xf8
            0F8560000000         | ..`...               | jnz 0x14d
            650F8209000000       | e......              | gs jc 0xfd
            6D                   | m                    | insd
            650F8446000000       | e..F...              | gs jz 0x142
            0F8351000000         | ..Q...               | jnc 0x153
            6C                   | l                    | insb
            6F                   | o                    | outsd
            6970202F414444       | ip /ADD              | imul esi,[eax+0x20],dword 0x4444412f
            2026                 |  &                   | and [esi],ah
            26206E65             | & ne                 | and [es:esi+0x65],ch
            0F84FEFFFFFF         | ......               | jz 0x115
            6C                   | l                    | insb
            6F                   | o                    | outsd
            63616C               | cal                  | arpl [ecx+0x6c],sp
            670F8249000000       | g..I...              | a16 jc 0x16c
            0F8546000000         | ..F...               | jnz 0x16f
            204164               |  Ad                  | and [ecx+0x64],al
            6D                   | m                    | insd
            696E6973747261       | inistra              | imul ebp,[esi+0x69],dword 0x61727473
            0F8441000000         | ..A...               | jz 0x17b
            0F8241000000         | ..A...               | jc 0x181
            206D65               |  me                  | and [ebp+0x65],ch
            0F842B000000         | ..+...               | jz 0x174
            0F8336000000         | ..6...               | jnc 0x185
            6C                   | l                    | insb
            6F                   | o                    | outsd
