    ...
    rule stage_shell___start0___x64
    {
        meta:
            desc = "Metasploit::windows::x64::stage_shell::__start0__"
    ...
    rule stage_shell_api_call_x64
    {
        meta:
            desc = "Metasploit::windows::x64::stage_shell::api_call"
    ...
    rule stage_shell_next_mod_x64
    {
        meta:
            desc = "Metasploit::windows::x64::stage_shell::next_mod"
    ...
    rule stage_shell_loop_modname_x64
    {
        meta:
            desc = "Metasploit::windows::x64::stage_shell::loop_modname"
    ...
    rule stage_shell_not_lowercase_x64
    {
        meta:
            desc = "Metasploit::windows::x64::stage_shell::not_lowercase"
    ...
    rule stage_shell_get_next_func_x64
    {
        meta:
            desc = "Metasploit::windows::x64::stage_shell::get_next_func"
    ...
    rule stage_shell_loop_funcname_x64
    {
        meta:
            desc = "Metasploit::windows::x64::stage_shell::loop_funcname"
    ...
    rule stage_shell_finish_x64
    {
        meta:
            desc = "Metasploit::windows::x64::stage_shell::finish"
    ...
    rule stage_shell_get_next_mod1_x64
    {
        meta:
            desc = "Metasploit::windows::x64::stage_shell::get_next_mod1"
    ...
    rule stage_shell_shell_x64
    {
        meta:
            desc = "Metasploit::windows::x64::stage_shell::shell"
    ...
    rule stage_shell_push_loop_x64
    {
        meta:
            desc = "Metasploit::windows::x64::stage_shell::push_loop"
    ...
    rule stage_shell_exitfunk_x64
    {
        meta:
            desc = "Metasploit::windows::x64::stage_shell::exitfunk"
    ...
    rule stage_shell_goodbye_x64
    {
        meta:
            desc = "Metasploit::windows::x64::stage_shell::goodbye"
